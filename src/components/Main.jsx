            ...
            <Router>
                <div className={`main bg-faded ${this.state.group}`}>
                    ...
                    <Route exact path="/" render={() => (
                        <Today unit={this.state.unit} city={this.state.city} onUnitChange={this.handleUnitChange} onCityChange={this.handleCityChange} />
                    )}/>
                    <Route exact path="/forecast" render={() => (
                        <Forecast unit={this.state.unit} city={this.state.city}/>
                    )}/>
                </div>
            </Router>
        );
